                ...
                <div className="space-y-2 text-sm text-gray-600">
                    ...
                    {props.evento.adendo && (
                        <div className="flex flex-col">
                            <span className="font-medium text-gray-900">Notas da reunião:</span>
                            <p className="mt-1 text-gray-500 italic">"{props.evento.adendo}"</p>
                        </div>
                    )}
                    ...
                    {props.evento.idGestor && (
                        <div className="flex items-center">
                            ...
                            <span className="font-medium text-gray-900">Gestores:</span>
